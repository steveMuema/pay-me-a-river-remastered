...
import { Stream } from "./CreatedStreamList";
...
export default function StreamCreator(props: {
  ...
  */
  const startStream = async () => {
    /* 
      Validate the address, amount, and date are all defined before continuing. Return early 
    ...
    */
    ...
    /* 
      Return early if the amount is not a number or is less than 0.
    */
    ...
    */
    ...
    props.setTxn(true);
    /* 
      Reset the address, amount, and date state variables
    */
    setAddress("");
    setAmount("");
    setDuration("1");
    /* 
      Create the payload for the create_stream transaction
    ...
    */
    const payload = {
      ...
      amount: parsedAmount*1e8,
      duration_in_seconds: parseDuration(duration)
    ...
    const transaction: Types.TransactionPayload = {
      ...
      type_arguments: [],
      arguments: [payload.receiver_address, payload.amount, payload.duration_in_seconds], // 1 is in Octas
    }
